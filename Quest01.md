...
<details>
<summary>리팩토링하는 퀘스트 ver 1.0</summary>

- [ ] 상대방의 메소드 하나를 잡아서 리팩토링해보기 (이유와 근거를 찾아서)

  S047\_이동현: 다른 동료의 코드를 더 자세히 분석할 기회라고 생각해서 선택하게 되었습니다.
```수정했고, 네부캠에서 벗어나서 수행할 수도 있는 퀘스트로 바꾸고 싶었습니다.```

</details>

- [ ] 일상에서 느끼는 리팩토링할 것 찾아서 리팩토링 하기 (이유와 근거를 찾아서)

  S047\_이동현: 일상의 모든 것들을 더 자세히 분석할 기회라고 생각해서 선택하게 되었습니다.
...
### 동료의 메소드 하나를 잡아서 리팩토링해보기 (이유와 근거를 찾아서) - S047 이동현
